...
The repository contains demon code for our paper [*Disentangled Explanations of Neural Network Predictions by Finding Relevant Subspaces* (published in TPAMI 2024)][paper].
